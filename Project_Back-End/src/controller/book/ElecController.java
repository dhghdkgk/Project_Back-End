...
public class ElecController extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (req.getMethod().equalsIgnoreCase("POST")) {
			...
			if (sucorfail == 1) {// 입력성공
				...
				req.getRequestDispatcher("/ElectronicLib/List.do").forward(req, resp);
			} // if
			...
			req.getRequestDispatcher("/admin/bootstrap/datasearch/ElectronicLibInsert.jsp").forward(req, resp);
		}
	}
